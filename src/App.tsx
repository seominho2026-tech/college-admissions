...
export default function App() {
  ...
  const handleExportCSV = () => {
    ...
    link.setAttribute("download", "대입_수시_결과_필터링_출력.csv");
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="bg-blue-800 text-emerald-400 text-[10px] font-bold px-2 py-0.5 rounded-full border border-blue-700 flex items-center gap-1">
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white border-l-4 border-l-blue-600 border border-slate-200 p-4 rounded-xl shadow-sm flex justify-between items-center relative overflow-hidden">
                <div className="space-y-1">
                  ...
                  <div className="flex items-baseline gap-2">
                    ...
                    <span className="text-xs font-semibold text-slate-400 font-mono">ITEMS</span>
                  </div>
              ...
              <div className="bg-white border-l-4 border-l-green-500 border border-slate-200 p-4 rounded-xl shadow-sm flex justify-between items-center relative overflow-hidden">
                <div className="space-y-1">
                  <p className="text-xs font-bold text-slate-500 uppercase mb-1">
                    합격 건수
                  </p>
                  <div className="flex items-baseline gap-2">
                    ...
                    <span className="text-xs font-semibold text-green-600 font-mono font-bold">
                      {stats.passRate}% PASS
                    </span>
                  </div>
              ...
              <div className="bg-white border-l-4 border-l-orange-500 border border-slate-200 p-4 rounded-xl shadow-sm flex justify-between items-center relative overflow-hidden">
                <div className="space-y-1">
                  <p className="text-xs font-bold text-slate-500 uppercase mb-1">
                    평균 합격 등급
                  </p>
              ...
              <div className="px-5 py-4 border-b border-slate-150 flex flex-col sm:flex-row justify-between items-center gap-3 bg-slate-50 rounded-t-xl">
                ...
                <div className="flex gap-2 self-stretch sm:self-auto">
                  <button
                    ...
                    className="flex-1 bg-white border border-slate-350 text-slate-700 hover:bg-slate-100 px-3 py-1.5 rounded-lg text-xs font-bold flex items-center justify-center gap-1.5 transition-colors cursor-pointer"
                  >
                ...
                <table className="w-full text-left border-collapse text-xs">
                  <thead className="bg-slate-100 border-b border-slate-200 sticky top-0">
                    <tr className="text-slate-500 uppercase font-bold text-[10px]">
                      <th className="px-4 py-3 pointer-events-none">학년도</th>
                      <th className="px-4 py-3 pointer-events-none">지역</th>
                      <th className="px-4 py-3 cursor-pointer select-none hover:text-blue-900" onClick={() => handleSort('university')}>
                      ...
                      <th className="px-4 py-3 cursor-pointer select-none hover:text-blue-900" onClick={() => handleSort('grade')}>
                        <div className="flex items-center gap-1 text-center justify-center">환산등급 <ArrowUpDown className="h-3 w-3" /></div>
                      </th>
                      <th className="px-4 py-3 cursor-pointer select-none hover:text-blue-900" onClick={() => handleSort('status')}>
                    ...
                    {paginatedRecords.length > 0 ? (
                      paginatedRecords.map((r, i) => (
                        <tr key={i} className="hover:bg-blue-50 transition-colors text-slate-700">
                          <td className="px-4 py-3 font-mono font-medium text-slate-400">{r.year}</td>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="inline-flex gap-1">
                    <button
                      ...
                      className="px-3 py-1.5 bg-white border border-slate-300 rounded-lg text-xs font-bold hover:bg-slate-100 disabled:opacity-40 select-none transition-colors"
                    >
                      이전
                    </button>
                    {createPageNumbers(currentPage, totalPages).map((p, i) => (
                      <button
                        ...
                        className={`px-3 py-1.5 text-xs font-extrabold rounded-lg select-none transition-colors ${
                          p === currentPage
